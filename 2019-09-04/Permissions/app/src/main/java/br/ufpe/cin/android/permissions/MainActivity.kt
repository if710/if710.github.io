...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private val INITIAL_PERMISSIONS = arrayOf(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_EXTERNAL_STORAGE)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!podeLocation() || !podeContacts() || !podeStorage()) {
    ...
    private fun atualizarInfo() {
        ...
        btn_storage.text = resources.getText(R.string.btn_txt_storage).toString() + ": " + podeStorage().toString()
    }
    ...
    private fun acessarArmazenamento() {
        Toast.makeText(this, R.string.msg_storage, Toast.LENGTH_SHORT).show()
    }
